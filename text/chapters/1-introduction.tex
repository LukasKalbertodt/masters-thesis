...
The main goal of this thesis is to release \code{lox} as a functional and well-design library that can easily be used by other programmers in many areas related to computer graphics and geometry processing.
