...
\begin{figure}[b]
  \centering
    ...
    \end{rustcode}
    \caption{
      The standard library's \codebox{Iterator} trait (provided methods omitted here).
...
While this high-level programming looks like it involves many method calls and significant runtime overhead, these iterator chains are compiled down to almost optimal machine code most of the time.
