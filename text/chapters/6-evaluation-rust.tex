...
\begin{itemize}
  ...
  The type of the iterator can be specified by mesh type implementing the adjacency trait, but the iterator also has to borrow from \code{self}.
...
While not many projects need to deal with HKTs, for \code{lox}, the problems caused by a lack of HKT features cost a notable amount of development time and made parts of the library's API worse than it could have been with those features.
