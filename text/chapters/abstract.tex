...
While choosing Rust as the programming language largely benefited the project, some of its limitations, like the lack of generic associated types, notably slowed down the development of \code{lox}.
