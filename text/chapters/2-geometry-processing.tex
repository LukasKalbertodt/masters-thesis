...
\begin{description}
  ...
  OpenMesh is the main focus of this thesis when it comes to comparison to other libraries.

  The library is cross-platform, written in C++ (though it also offers Python bindings) and mainly features a customizable implementation of a half-edge mesh.
  ...
  \item [PMP] The \textbf{P}olygon \textbf{M}esh \textbf{P}rocessing library \cite{pmp-library}, written in C++, offers a half-edge mesh data structure, several mesh algorithms and functionality for visualizing meshes.
  ...
  \item [VCGlib] A C++ library for manipulating, processing and displaying 3D meshes \cite{vcglibhomepage}.
